   ...
   var labelSemestre=document.getElementById('labelSemestre');
      ...
      if(formulario.bac_alu.value=="0"){
       ...
       if(formulario.fnac_alu.value.length==0){
         ...
         var regLugarNacimiento= "[a-zA-ZÑÜ]";
...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell layout-item-1" style="width: 50%" >
        ...
        <!-- CVE CICLO CAJA -->
        <br>
        <span style="font-weight: bold;">H.ZITÃ?CUARO,MICH.A
...
<img src='../../images/iconos/shutdown.ico' width=35 height=35>SALIR</a>
    </div>
    </div>
</form>
</div>
