...
if(sizeof($publicacion)==0){
	...
	$cadena.="<img src='images/s-2.png' width='260px' height='180px' /></a>";
	$cadena.="<div data-u='thumb'>No hay noticias disponibles este mes";
	$cadena.="</div>";
	$cadena.="</div>";
}
else{
...
<!--MENU PRINCIPAL-->
    ...
    <li><a href="#">Blog</a><ul>
        <li><a href="http://www.prepamoreloszitacuaro.blogspot.com">Blog escolar</a></li>
        <li><a href="blog/noticias.php">Noticias</a></li><li><a href="blog/galeria.html">Galería</a></li></ul></li></ul> 
    </nav>
...
<div class="art-sheet clearfix">
    ...
    <h3><a href='blog/noticias.php' style='text-transform:none;'>Leer más</a></h3>
    </div>
    </div>
</div>
...
<article class="art-post art-article">
								...
								<div class="art-content-layout">
    <div class="art-content-layout-row">
    <div class="art-layout-cell" style="width: 100%" ><br><br>
        <p style="text-align: center;"><b><span style="line-height: 107%; font-family: 'Lucida Calligraphy'; color: rgb(251, 124, 60); font-size: 36px;">Bienvenidos</span></b><span style="font-size: 22px;"><br>
          </span></p>
    </div>
    </div>
</div><br>
<div class="art-content-layout">
    <div class="art-content-layout-row">
    <div class="art-layout-cell" style="width: 100%" >
        <p style="line-height: 125%;"><span style="color: rgb(51, 51, 51); line-height: 16.25px; background-color: rgba(242, 244, 246, 0.792969);">
        La Escuela Preparatoria José Ma. Morelos de Zitácuaro,es una institución educativa de nivel medio superior incoporada a la Universidad Michoacana de San Nicolás de <span style="letter-spacing: 1px;">Hidalgo</span>.</span><br></p><p style="line-height: 125%;"><span style="color: rgb(51, 51, 51); line-height: 16.25px; background-color: rgba(242, 244, 246, 0.792969);">
        Es una institución que fomenta la cultura,los valores y&nbsp;la educación al más alto nivel acad&eacute;mico y humano,para formar&nbsp;jóvenes qui&eacute;nes promuevan el bienestar y el progreso de la sociedad.</span><span style="color: rgb(51, 51, 51); line-height: 16.25px; background-color: rgba(242, 244, 246, 0.792969);"><br></span></p>
    </div>
    </div>
</div>
...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell" style="width: 100%" >
        <p>
            <!--PROMO GIF-->
        <!--<img alt="" src="images/promo.gif" style="background: #999999;
  border: 1px solid #666666;
  -moz-border-radius: 5px;
  -webkit-border-radius: 5px;
  border-radius: 5px; margin: 20px auto;
  padding: 5px;" width='672'>-->
...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell" style="width: 100%" >
         ...
         swf: 'js/videojs/video-js.swf'
           ...
           <video id="example_video_1" class="video-js vjs-default-skin" controls preload="none" width="640" height="360" poster="images/morelospreview.png" data-setup='{ "html5" : { "nativeTextTracks" : false } }'>
...
<br><br><br>
        <p><span style="color: rgb(51, 51, 51); line-height: 16.25px; background-color: rgba(242, 244, 246, 0.796875);"><span style="color: rgb(0, 9, 61); font-weight: bold; line-height: 18px;">Aquí encontrarás informaci&oacute;n relacionada con la instituci&oacute;n.</span><br></span></p>
        
        <p style="box-sizing: border-box; color: rgb(51, 51, 51); background-color: rgba(242, 244, 246, 0.792969); line-height: 19.5px;">Desde &eacute;ste espacio podrás conocernos,saber nuestra ubicaci&oacute;n, noticias relevantes;as&iacute; como eventos y actividades realizadas durante el transcurso del ciclo escolar.</p>
...
<div class="art-content-layout">
 ...
 <!--<iframe width="640" height="360" src="archivos/video-promocional.mp4" frameborder="0" allowfullscreen="" style="background: #999999;
  border: 1px solid #666666;
  -moz-border-radius: 5px;
  -webkit-border-radius: 5px;
  border-radius: 5px; margin: 20px auto;
...
<!--  <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" width="640" height="360" id="player1" align="middle"> 
<param name="movie" value="video-promocional.swf"/> 
...
<embed src="archivos/video-promocional.swf" menu="false" quality="high" bgcolor="#FFFFFF" width="640" height="360" name="player" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"  style="background: #999999;
  border: 1px solid #666666;
  -moz-border-radius: 5px;
  -webkit-border-radius: 5px;
  border-radius: 5px; margin: 20px auto;
...
<!--  
        ...
        <param name="src" value="video-promocional.swf"> 
        <embed src="archivos/video-promocional.swf" 
            type="application/x-shockwave-flash" 
            pluginspage="http://www.adobe.com/go/getflashplayer" width="640" height="360" style="background: #999999;
  border: 1px solid #666666;
  -moz-border-radius: 5px;
  -webkit-border-radius: 5px;
  border-radius: 5px; margin: 20px auto;
...
<!--  -->
     ...
     <!-- PROMO -->
     <img width="490" height="320" alt="" src="images/logo1-large.png" class="">
...
<br><br>
    ...
    <div class="art-vmenublock clearfix">
        <div class="art-vmenublockcontent">
             <ul class="art-vmenu">
             <li><a href="inicio.html" class="active"><span class="glyphicon glyphicon-home">&nbsp;Inicio</span></a></li>
             <li><a href="#"><span class="glyphicon glyphicon-question-sign">&nbsp;Acerca de</span></a><ul>
                 <li><a href="acerca-de/quienes-somos.html">Qui&eacute;nes Somos</a></li>
                 <li><a href="acerca-de/ubicacion.html">Ubicación</a></li>
                 <li><a href="acerca-de/directorio.html">Directorio</a></li>
                 <li><a href="archivos/pdf/web/reglamento_preview.html" target='_blank'>Reglamento</a></li></ul></li>
                 
            <li><a href="#"><span class="glyphicon glyphicon-briefcase">&nbsp;Bachilleratos</span></a><ul>
               ...
               <!--</ul></li>-->
               <li><a href="#"><span class="glyphicon glyphicon-user">&nbsp;Usuarios</span></a><ul>
              <li><a href="#">Alumnos</a><ul>
                  <li><a href="usuarios/alumnos/calificaciones.html">Calificaciones</a></li>
                  <li><a href="usuarios/alumnos/solicitud-reinscripcion.html">Solicitud de reinscripci&oacute;n</a></li>
              ...
              <li><a href="#"><span class="glyphicon glyphicon-folder-close">&nbsp;Blog</span></a><ul>
                  <li><a href="http://www.prepamoreloszitacuaro.blogspot.com">Blog escolar</a></li>
...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell layout-item-old-0" style="width: 100%">
        <p style="text-align: center;">
             <a  data-toggle="modal"  
   data-target="#myMod1" href='#' style='color:white;text-decoration:none;'>Acerca de</a>
            |
...
<div class="modal fade" id="myMod" tabindex="-1" role="dialog"  
   ...
   <div class="modal-dialog" style='background:url(images/block.png)'>       
    <div class="modal-content"> 
         <div class="modal-header" > 
            ...
            <h4 class="modal-title" id="myModalLabel"> 
             <span style="line-height: 107%; font-family: 'Lucida Calligraphy'; color: rgb(91, 155, 213); font-size: 30px;">Politicas de Privacidad</span>
            </h4> 
         </div> 
         <div class="modal-body" style='background:url(images/block.png)'> 
           <h4 style='color:#000034;'><img src='images/logo-3.png' width='65' height='60'> 
            Escuela preparatoria José Ma. Morelos de Zitácuaro,S.C</h4>
            <hr><br>
            <b style='color:blue;'>Para mayor información sirvase a leer el documento completo.</b>
            <ul style="text-align:justify;">
            <li>
           <b style='color:black;'> 
            La Escuela preparatoria José Ma. Morelos de Zitácuaro,S.C,está incorporada a la U.M.S.N.H;la cual se menciona como referencia a dicha institución.
        </b>
            </li>
               <li>
           <b style='color:black;'> 
            La información recabada para el seguimiento de trámite de reinscripción es requerida por control escolar para su expediente.
        </b>
            </li>
               <li>
           <b style='color:black;'> 
            Los alumnos y/o personal docente que haga uso del los servicios online debe estar registrado en el sistema,por lo cual está restringido el acceso.
        </b>
            </li>
               <li>
           <b style='color:black;'> 
            La información adicional y/o personal proporcionada por el usuario, es usada para fines estadisticos y disminución paulatina del  registro de solicitud en cuestión.
            La información esta sujeta a cambios por parte del usuario si así lo desea,el cual puede modificar dicha información y solicitar su resguardo bajo su criterio.
        </b>
            </li>
               <li>
           <b style='color:black;'> 
            Los datos,servicios u operaciones mencionados estáran disponibles solo en periodo de reinscripciones para mayor comodidad (incluyendo un periodo adicional,previo aviso) y unicamente para usuarios autorizados y/o registrados.
        </b>
            </li>
               <li>
           <b style='color:black;'> 
            Los formatos que se presentan de manera directa o indirecta en esta página fueron revisados previa autorización,sin  propósito o intención
            de acoplar,agregar información adicional o innecesaria,o suprimir alguna referente,que desconozca la participación de la institución o derechos 
            de la misma acoplandose de la mejor manera al formato y visualización web y sin dolo alguno,con la intención de apoyar unicamente a la consulta y/o seguimiento del trámite en cuestión.
            (ESCUELA PREPARATORIA JOSÉ MA. MORELOS DE ZITÁCUARO,S.C;U.M.S.N.H,ICATMI)

        </b>
            </li>
               <li>
           <b style='color:black;'> 
            La aparición continua o fortruita de personas relacionadas a la escuela:
            estudiantes,profesores,personal administrativo y que labore,imparta cátedra,o estudie en la institución;
            ocurre en los periodos en los que dichas personas mencionadas se encuentren en la preparatoria ,por lo cual
          se reconoce  y se agradece la participación de: alumnado en general,administrativos,docentes,
           por representar  a la institución de la mejor manera,dando muestra de sus valores,logros
          académicos,deportivos y demás por mencionar dentro de la misma.
          De esta manera se hace hincapie,respecto a su participación;
          y se aclara la libertad de decidir seguir participando durante su estancia,notificando de ello debidamente a los 
          representantes de la misma.
        </b>
            </li>
               <li>
           <b style='color:black;'> 
            Los acuerdos por escrito,asi como las políticas,reglamentos y convenios  con terceras personas se encuentran
            disponibles(si es el caso),con los representantes actuales de la institución para cotejamiento previo.
            La información proporcionada en esta web esta dedicada para brindar acceso a servicios,información y contacto con
            la Escuela Preparatoria José Ma. Morelos de Zitácuaro,S.C,sin fines de lucro o dolo y de mutuo acuerdo.
            Para una referencia más completa acerca de los acuerdos con terceros consultar este enlace
            <a href='archivos/pdf/web/acuerdos.html' target='_blank' style='color:blue;text-decoration:none;'>ACUERDOS CON TERCEROS</a>
        </b>
            </li>
            <li>
                <b style='color:black;'>
                 Los desarrolladores y/o personal relacionado en la elaboración de la página se deslinda del mal uso del portal por parte del
                 usuario que incurra en prácticas no seguras como compartir su información personal,claves de acceso,compartir correo o cuentas de correo electrónica con 
                 personas ajenas a la institución o acceso desde servidores que hagan en uso de VPN u otros medios similares,como redes no seguras.
                 EL usuario esta conciente de las ventajas y desventajas que lo anterior representa y por lo tanto recordará cerrar sesión en su navegador 
                 y evitar compartir dispositivos tales como teléfonos celulares,computadoras portatiles si asi fuera el caso para evitar este tipo de 
                 incidentes.
                </b>
            </li>
            <li>
                <b style='color:black;'>
                Los terminos del presente documento estan sujetos a cambios en cualquier momento,asi como el cese de servicios y acceso a los mismos por parte del usuario.
                </b>
            </li>
               <li>
           <b style='color:black;'> 
            La disponibilidad de datos para consulta,uso de servicios y acceso a la página estará disponible en las secciones 
            correspondientes de acuerdo al periodo requerido(o periodo extra si fuera el caso),teniendo en cuenta el dispositivo
            usado por el usuario para el acceso a la página y el rendimiento del equipo de cómputo,considerando un comportamiento 
            distinto en distintos casos,excluyendo de ello a la página y/o desarrollador. 
            Página adaptada para dispositivos móviles,pudiendo no visualizarse en algunos dispositivos y navegadores antiguos.
            El contenido que aparece en la página y hace referencia a la institución y/o terceros pertenece a las mismas,no perteneciendo
            a persona en particular(participantes directos o indirectos en la elaboración de la página,excluyendo de dicha responsabilidad a estos).
            Para más información y/o dudas,dirigirse a las instancias correspondientes o  realizar contacto por medio electrónico a las direcciones mencionadas en pie de página. 
        </b>
            </li>
         ...
         <div class="modal-footer" style='background:url(images/block.png)'> 
            <h4 style='color:#000034;'>Actualización 10 de Julio del 2016</h4>
            <br>
