...
<script type="text/javascript">
 ...
 $(document).ready(function(){
    ...
    function verAgenda(dias,mes){
		document.getElementById("modal-noticias").innerHTML="<h3><span class='glyphicon glyphicon-alert'></span> &nbsp;No hay noticias por el momento!</h3>";
	}
...
foreach ($publicacion as $noticias){
	 ...
	 Junio 2016
	 El array de noticias se indexa con los valores de la columnas de la consulta de mysql,por lo cual los campos que se
	 obtienen de acuerdo al indice del array son los siguientes,los cuales se usan para la publicacion.
	 *******************************************************************************************************************
	...
	$cadena.="<a href='http://localhost:88/morelosjuniook/blog/noticias.php?idpublicacion=".$noticias[0]."'>";
	$cadena.="<img data-u='image' src='images/".$noticias[7]."' /></a>";
...
<!--MENU PRINCIPAL-->
    ...
    <ul class="art-hmenu">
    <li><a href="inicio" class="active">Inicio</a></li><li><a href="#">Acerca de</a><ul><li><a href="acerca-de/quienes-somos.html">Quienes Somos</a></li><li><a href="acerca-de/ubicacion.html">Ubicación</a></li><li><a href="acerca-de/directorio.html">Directorio</a></li><li><a href="acerca-de/reglamento.html">Reglamento</a></li></ul></li><li><a href="#">Preparatoria</a><ul><li><a href="preparatoria/formacion-educativa.html">Formación Educativa</a></li><li><a href="#">Bachilleratos</a><ul><li><a href="preparatoria/bachilleratos/ciencias-economico-administrativas.html">Ciencias Económico-Administrativas</a></li><li><a href="preparatoria/bachilleratos/ciencias-historico-sociales.html">Ciencias Historico-Sociales</a></li><li><a href="preparatoria/bachilleratos/ciencias-quimico-biologicas.html">Ciencias Químico-Biológicas</a></li><li><a href="preparatoria/bachilleratos/ingenieria-y-arquitectura.html">Ingeniería y Arquitectura</a></li></ul></li></ul></li><li><a href="#">Usuarios</a><ul><li><a href="#">Alumnos</a><ul><li><a href="usuarios/alumnos/calificaciones.html">Calificaciones</a></li><li><a href="usuarios/alumnos/solicitud-reinscripcion.html">Solicitud Reinscripcion</a></li><li><a href="usuarios/alumnos/consulta-de-horario.html">Consulta de Horario</a></li></ul></li><li><a href="usuarios/futuros-estudiantes.html">Futuros Estudiantes</a></li><li><a href="#">Docentes</a><ul><li><a href="usuarios/docentes/temarios.html">Temarios</a></li><li><a href="usuarios/docentes/formatos.html">Formatos</a></li></ul></li><li><a href="#">Padres de Familia</a><ul><li><a href="usuarios/padres-de-familia/buzon.html">Buzón</a></li></ul></li></ul></li><li><a href="#">Servicios</a><ul><li><a href="servicios/biblioteca.html">Biblioteca</a></li><li><a href="servicios/trabajo-social.html">Trabajo Social</a></li><li><a href="servicios/psicologia.html">Psicología</a></li><li><a href="servicios/control-escolar.html">Control Escolar</a></li><li><a href="servicios/centro-de-computo.html">Centro de Cómputo</a></li><li><a href="servicios/prefectura.html">Prefectura</a></li><li><a href="servicios/subdireccion-academica.html">Subdirección Académica</a></li></ul></li><li><a href="#">Blog</a><ul><li><a href="blog/noticias">Noticias</a></li><li><a href="blog/galeria.html">Galería</a></li></ul></li></ul> 
    </nav>
...
<div class="art-content-layout">
    <div class="art-content-layout-row">
    <div class="art-layout-cell" style="width: 100%" >
        <p><span style="color: rgb(51, 51, 51); line-height: 16.25px; background-color: rgba(242, 244, 246, 0.796875);"><span style="color: rgb(0, 9, 61); font-weight: bold; line-height: 18px;">Aquí encontrarás todo cuanto necesitas saber de Nosotros.</span><br></span></p><p style="box-sizing: border-box; color: rgb(51, 51, 51); background-color: rgba(242, 244, 246, 0.792969); line-height: 19.5px;">Desde aquí podrás Conocernos, saber donde nos Ubicamos, Noticias Relevantes, Eventos y Actividades realizadas durante el transcurso del ciclo escolar.</p><p style="box-sizing: border-box; color: rgb(51, 51, 51); line-height: 18.571428298950195px; background-color: rgba(242, 244, 246, 0.792969);"><br style="box-sizing: border-box;"></p><p style="box-sizing: border-box; color: rgb(51, 51, 51); line-height: 18.571428298950195px; background-color: rgba(242, 244, 246, 0.796875); text-align: left;"><span style="box-sizing: border-box; font-weight: bold; text-align: justify; color: rgb(0, 9, 61);">¡Te damos la más cordial bienvenida a nuestro sitio web!</span></p><p><span style="color: rgb(51, 51, 51); line-height: 16.25px; background-color: rgba(242, 244, 246, 0.796875);"><br></span></p>
    </div>
    </div>
</div>
<div class="art-content-layout">
    ...
    <div class="art-layout-cell" style="width: 100%" >
        <p>
<iframe width="640" height="360" src=" " frameborder="0" allowfullscreen=""></iframe><br></p>
    </div>
    </div>
</div>
<div class="art-content-layout layout-item-old-5">
    ...
    <div class="art-layout-cell layout-item-0" style="width: 100%" >
        <h2 align="center" style="box-sizing: border-box; line-height: 26.399999618530273px;"><span style="box-sizing: border-box; font-weight: bold; text-align: center; -webkit-border-horizontal-spacing: 2px; -webkit-border-vertical-spacing: 2px; color: rgb(0, 9, 61); font-size: 16px;">NOTICIAS&nbsp;</span></h2>
...
-moz-border-radius: 6px;border-radius: 6px;-webkit-box-shadow: 0 0 3px 2px rgba(0, 0, 0, 0.2);-moz-box-shadow: 0 0 3px 2px rgba(0, 0, 0, 0.2);box-shadow: 0 0 3px 2px rgba(0, 0, 0, 0.2);border: 1px solid #B2C1D1;margin: 7px;"> 
   ...
   <span style="line-height: 107%; font-family: 'Lucida Calligraphy'; color: rgb(91, 155, 213); font-size: 30px;">Noticias</span>
            </h4> 
         </div> 
