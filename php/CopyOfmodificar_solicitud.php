	...
	if(sizeof($datosPadre)>0){
	   ...
	   if(sizeof($datosPadreColonia)>0){
	     ...
	     foreach ($datosCiudadPadre as $ciudadesPadre) {
	     	$cpCiudadPadre=$ciudades->getCpCiudad();
	     	$cpEstadoPadre=$ciudades->getCpEstado();
	     	$nombreCiudadPadre=$ciudades->getNombreCiudad();
	     	//
	     	//ESTADOS
...
<div id="tabs">
	<ul>
		<li style="text-decoration: none;"><a href="#tabs-1">&nbsp;&nbsp;&nbsp;<img src='../images/iconos/editar.png' width='35' heigth='35'>Datos Personales&nbsp;&nbsp;&nbsp;</a></li>
		<li><a href="#tabs-2">&nbsp;&nbsp;&nbsp;<img src='../images/iconos/sistema.png' width='35' heigth='35'>Datos adicionales&nbsp;&nbsp;&nbsp;</a></li>
		<li><a href="#tabs-3">&nbsp;&nbsp;&nbsp;<img src='../images/iconos/user.ico' width='35' heigth='35'>Datos del padre o tutor&nbsp;&nbsp;&nbsp;</a></li>
		<li><a href="#tabs-4">&nbsp;&nbsp;&nbsp;<img src='../images/iconos/registro.png' width='35' heigth='35'>Datos de la solicitud&nbsp;&nbsp;&nbsp;</a></li>
		<li><a href="#tabs-5">&nbsp;&nbsp;&nbsp;<img src='../images/iconos/shutdown.ico' width='35' heigth='35'>Salir&nbsp;&nbsp;&nbsp;</a></li>
		<li><a href="#tabs-6">&nbsp;&nbsp;&nbsp;<img src='../images/iconos/informacion.png' width='35' heigth='35'>Informaci&oacute;n&nbsp;&nbsp;&nbsp;</a></li>
	</ul>
	<div id="tabs-1">
	...
	<input type='button' class='ui-button-text' value='Modificar datos' onclick="javascript:modificarAlumno();"/>
	<br>
	<a href='modificar_solicitud.php' class='ui-button-text'>
    ...
    <br>
    <input type='button' value='Modificar datos' onclick="javascript:modificarDatosExtra();">
	</fieldset>
...
<br>
	...
	<input type="button" value="Modificar datos" onclick="javascript:modificarPadre();">
	</fieldset>
	<br>
	...
	<br>
	<input type='button' onclick="javascript:cambiarInscripcion();"value="MODIFICAR DATOS">
   ...
   <p>NOTAS:
   <ul>
   <li>Los datos marcados con * son Obligatorios
   </li>
   <ol>Si el c&oacute;digo postal no se encuentra  se quedar&aacute; en blanco, puedes cambiarlo o dejarlo</ol>
   <ol>Cambia los datos en la secci&oacute;n indicada</ol>
   <ol>Los datos se guardar&aacute;n al dar clic en el bot&oacute;n de modificar datos</ol>
   <ol>Revisa tus datos y envia la solicitud</ol>
   </ul></p>
 ...
 <br><input type='submit' class='btn btn-primary' value='Enviar Solicitud'>
 <a href='<?php $_SERVER['HTTP_REFERER'];?>' style='text-decoration: none;'><input type='button' class='btn btn-default' value='Actualizar cambios'></a>
...
<div id="dialog-padre" title="AVISO" style='display: none;'>
	...
	LOS DATOS SE MODIFICARAN,ESTAS SEGURO?</p>
