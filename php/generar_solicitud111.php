...
<h3 align='center'>
<input type='hidden' name="datosm0" value='<?php echo $datos_morelos[0];?>'>
<input type='hidden' name="datosm1" value='<?php echo $datos_morelos[1];?>'>
<input type='hidden' name="datosm2" value='<?php echo $datos_morelos[2];?>'>
<input type='hidden' name="datosm3" value='<?php echo $datos_morelos[3];?>'>
<input type='hidden' name="datosm4" value='<?php echo $datos_morelos[4];?>'>
<input type='hidden' name="datosm5" value='<?php echo $datos_morelos[5];?>'>
<input type='hidden' name="datosm6" value='<?php echo $datos_morelos[6];?>'>
<input type='hidden' name="datosm7" value='<?php echo $datos_morelos[7];?>'>
<input type='hidden' name="datosm8" value='<?php echo $datos_morelos[8];?>'>
<input type='hidden' name="datosm9" value='<?php echo $datos_morelos[9];?>'>
<input type='hidden' name="datosm10" value='<?php echo $datos_morelos[10];?>'>
<input type='hidden' name="datosm11" value='<?php echo $datos_morelos[11];?>'>
<input type='hidden' name="datosm12" value='<?php echo $datos_morelos[12];?>'>
<input type='hidden' name="datosm13" value='<?php echo $datos_morelos[13];?>'>
<input type='hidden' name="datosm14" value='<?php echo $datos_morelos[14];?>'>
<input type='hidden' name="datosm15" value='<?php echo $datos_morelos[15];?>'>
<input type='hidden' name="datosm16" value='<?php echo $datos_morelos[16];?>'>
<input type='hidden' name="datosm17" value='<?php echo $datos_morelos[17];?>'>
<input type='hidden' name="datosm18" value='<?php echo $datos_morelos[18];?>'>
<input type='hidden' name="datosm19" value='<?php echo $datos_morelos[19];?>'>
<input type='hidden' name="datosm20" value='<?php echo $datos_morelos[20];?>'>
<input type='hidden' name="datosm21" value='<?php echo $datos_morelos[21];?>'>
<input type='hidden' name="datosm22" value='<?php echo $datos_morelos[22];?>'>
<input type='hidden' name="datosm23" value='<?php echo $datos_morelos[23];?>'>
<input type='hidden' name="datosm24" value='<?php echo $datos_morelos[24];?>'>
<input type='hidden' name="datosm25" value='<?php echo $datos_morelos[25];?>'>
<input type='hidden' name="datosm26" value='<?php echo $datos_morelos[26];?>'>
<input type='hidden' name="datosm27" value='<?php echo $datos_morelos[27];?>'>
<input type='hidden' name="datosm28" value='<?php echo $datos_morelos[28];?>'>
<input type='hidden' name="datosm29" value='<?php echo $datos_morelos[29];?>'>
<input type='hidden' name="datosm30" value='<?php echo $datos_morelos[30];?>'>
<input type='hidden' name="datosm31" value='<?php echo $datos_morelos[31];?>'>
<input type='hidden' name="datosm32" value='<?php echo $datos_morelos[32];?>'>
<input type='hidden' name="datosm33" value='<?php echo $datos_morelos[33];?>'>
<input type='hidden' name="datosm34" value='<?php echo $datos_morelos[34];?>'>
<input type='hidden' name="datosm35" value='<?php echo $datos_morelos[35];?>'>
<input type='hidden' name="datosm36" value='<?php echo $datos_morelos[36];?>'>
<input type='hidden' name="datosm37" value='<?php echo $datos_morelos[37];?>'>
<input type='hidden' name="datosm38" value='<?php echo $datos_morelos[38];?>'>
<input type='hidden' name="datosm39" value='<?php echo $datos_morelos[39];?>'>
<input type='hidden' name="datosm40" value='<?php echo $datos_morelos[40];?>'>
<input type='hidden' name="datosm41" value='<?php echo $datos_morelos[41];?>'>
<input type='hidden' name="datosm42" value='<?php echo $datos_morelos[42];?>'>
<input type='hidden' name="datosm43" value='<?php echo $datos_morelos[43];?>'>
<input type='hidden' name="datosm44" value='<?php echo $datos_morelos[44];?>'>
<input type='hidden' name="datosm45" value='<?php echo $datos_morelos[45];?>'>





<input type='hidden' name="datosi0" value='<?php echo $datos_icatmi[0];?>'>
<input type='hidden' name="datosi1" value='<?php echo $datos_icatmi[1];?>'>
<input type='hidden' name="datosi2" value='<?php echo $datos_icatmi[2];?>'>
<input type='hidden' name="datosi3" value='<?php echo $datos_icatmi[3];?>'>
<input type='hidden' name="datosi4" value='<?php echo $datos_icatmi[4];?>'>
<input type='hidden' name="datosi5" value='<?php echo $datos_icatmi[5];?>'>
<input type='hidden' name="datosi6" value='<?php echo $datos_icatmi[6];?>'>
<input type='hidden' name="datosi7" value='<?php echo $datos_icatmi[7];?>'>
<input type='hidden' name="datosi8" value='<?php echo $datos_icatmi[8];?>'>
<input type='hidden' name="datosi9" value='<?php echo $datos_icatmi[9];?>'>
<input type='hidden' name="datosi10" value='<?php echo $datos_icatmi[10];?>'>
<input type='hidden' name="datosi11" value='<?php echo $datos_icatmi[11];?>'>
<input type='hidden' name="datosi12" value='<?php echo $datos_icatmi[12];?>'>
<input type='hidden' name="datosi13" value='<?php echo $datos_icatmi[13];?>'>
<input type='hidden' name="datosi14" value='<?php echo $datos_icatmi[14];?>'>
<input type='hidden' name="datosi15" value='<?php echo $datos_icatmi[15];?>'>
<input type='hidden' name="datosi16" value='<?php echo $datos_icatmi[16];?>'>
<input type='hidden' name="datosi17" value='<?php echo $datos_icatmi[17];?>'>
<input type='hidden' name="datosi18" value='<?php echo $datos_icatmi[18];?>'>
<input type='hidden' name="datosi19" value='<?php echo $datos_icatmi[19];?>'>
<input type='hidden' name="datosi20" value='<?php echo $datos_icatmi[20];?>'>
<input type='hidden' name="datosi21" value='<?php echo $datos_icatmi[21];?>'>
<input type='hidden' name="datosi22" value='<?php echo $datos_icatmi[22];?>'>
<input type='hidden' name="datosi23" value='<?php echo $datos_icatmi[23];?>'>
<input type='hidden' name="datosi24" value='<?php echo $datos_icatmi[24];?>'>
<input type='hidden' name="datosi25" value='<?php echo $datos_icatmi[25];?>'>
<input type='hidden' name="datosi26" value='<?php echo $datos_icatmi[26];?>'>
<input type='hidden' name="datosi27" value='<?php echo $datos_icatmi[27];?>'>
<input type='hidden' name="datosi28" value='<?php echo $datos_icatmi[28];?>'>
<input type='hidden' name="datosi29" value='<?php echo $datos_icatmi[29];?>'>
...
<input type="submit" value=' Imprimir Solicitudes'>
<br><br>
