<?php 
		class Conexion{
			...
			function Conexion(){
				...
				$this->contrasena="morelos123"; //contraseña que tengas definidad
				$this->baseDatos="morelos"; //base de datos personas, si quieres utilizar otra base de datos solamente cambiala
			}
			...
			function conectarse(){		
				...
				$enlace = mysqli_connect($this->ruta, $this->usuario, 'morelos123', $this->baseDatos);
				if($enlace){
