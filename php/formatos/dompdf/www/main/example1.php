...
$datosBachillerato=$tablaBachillerato->consultaBachillerato($datosM[41]);
...
$datosColonias=$tablaColonias->reporteEspecificoColonia("id_col", $datosM[14]);
...
$datosCiudades=$tablaCiudades->reporteEspecificoCiudad("cp_ciu", $datosM[16]);
...
$datosEstados=$tablaEstados->consultaEstado($datosM[17]);
...
$cadenaPSalud="";
if($datosM[21]=="si"){
	$cadenaPSalud=" SI ( X ) NO ( ) &nbsp;&nbsp;".$datosM[32];
}
else{
	$cadenaPSalud=" SI ( ) NO ( X ) &nbsp;&nbsp;".$datosM[32];;
}
//
//BECA ALU
$cadenaBeca="";
...
if($datosM[22]=="si"){
	$cadenaBeca=" SI ( X ) NO ( ) &nbsp;&nbsp;".$datosM[23];
}
else{
	$cadenaBeca=" SI ( ) NO ( X ) &nbsp;&nbsp;".$datosM[23];
}
//
//SERVICIO DE SALUD
$cadenasSalud="";
if($datosM[24]=="si"){
	$cadenasSalud=" SI ( X ) NO ( ) &nbsp;&nbsp;".$datosM[25];
}
else{
	$cadenasSalud=" SI ( ) NO ( X ) &nbsp;&nbsp;".$datosM[25];
}
//
//CADENA LENGUA ALUMNO
$cadenaLengua="";
if($datosM[26]=="si"){
	$cadenaLengua=" SI ( X ) NO ( ) &nbsp;&nbsp;".$datosM[27];
}
else{
	$cadenaLengua=" SI ( ) NO ( X ) &nbsp;&nbsp;".$datosM[27];
}
//
//ECIVIL PADRE
$cadenaECivilPadre="";
...
$datosColoniaPadre=$tablaColoniaPadre->reporteEspecificoColonia("id_col", $datosM[37]);
...
$datosCiudadPadre=$tablaCiudadPadre->reporteEspecificoCiudad("cp_ciu", $datosM[38]);
...
$datosEstadoPadre=$tablaEstadoPadre->consultaEstado($datosM[39]);
...
$nomColonia="";
$datosColonia=$tablaColonia->reporteEspecificoColonia("id_col", $datosI[13]);
...
$nomCiudad="";
$datosCiudad=$tablaCiudad->reporteEspecificoCiudad("cp_ciu", $datosI[14]);
...
<td class="field">'.$datosM[6].' </td>
<td class="label">SECCION</td>
<td class="field">'.$datosM[4].'</td>
</tr>
...
<tr>
  ...
  <td colspan="3" class="field" style="width: 16.5%">'.strtoupper($datosM[7]).'&nbsp;'.strtoupper($datosM[8]).'&nbsp;'.strtoupper($datosM[9]).'</td>
...
<tr>
  ...
  <td colspan="3" class="field" style="width: 16.5%">'.strtoupper($datosM[10]).'</td>
  <td class="label" style="width: 8.25%">LUGAR DE NACIMIENTO </td>
  <td colspan="2" class="field" style="width: 16.5%">'.strtoupper($datosM[11]).' </td>
  </tr>
<tr>
  <td class="label" style="width: 8.25%">DOMICILIO</td>
  <td colspan="6" class="field" style="width: 16.5%">'.strtoupper($datosM[12]).','.strtoupper($datosM[13]).'</td>
  </tr>
<tr>
  ...
  <td colspan="2" class="field" style="width: 16.5%">'.$datosM[15].'</td>
  </tr>
<tr>
...
<tr>
  ...
  <td class="field" style="width: 16.5%">'.strtoupper($datosM[18]).' </td>
  <td colspan="2" class="field" style="width: 8.25%">'.strtoupper($datosM[19]).'</td>
  <td class="label" style="width: 8.25%">E-MAIL </td>
  <td colspan="2" class="field" style="width: 16.5%">'.strtoupper($datosM[20]).' </td>
  </tr>
<tr>
...
<tr>
  <td class="label" style="width: 8.25%">NOMBRE</td>
  <td class="field" style="width: 16.5%">'.strtoupper($datosM[28]).'&nbsp;'.strtoupper($datosM[29]).'&nbsp;'.strtoupper($datosM[30]).' </td>
...
<tr>
  ...
  <td colspan="6" class="field" style="width: 16.5%">'.strtoupper($datosM[34]).','.strtoupper($datosM[35]).' </td>
  </tr>
<tr>
  <td class="label" style="width: 8.25%">COLONIA</td>
  <td colspan="3" class="field" style="width: 16.5%">'.strtoupper($nombreColoniaPadre).'</td>
  <td class="label" style="width: 8.25%">CODIGO POSTAL </td>
  <td colspan="2" class="field" style="width: 16.5%">'.$datosM[36].'</td>
  </tr>
<tr>
  <td class="label" style="width: 8.25%">CIUDAD</td>
...
<tr>
  <td class="label" style="width: 8.25%">TELEFONOS</td>
  <td colspan="3" class="field" style="width: 16.5%">'.strtoupper($datosM[40]).'&nbsp;&nbsp;&nbsp;Y &nbsp;&nbsp;&nbsp;'.strtoupper($datosM[42]).' </td>
  <td class="label" style="width: 8.25%">E-MAIL </td>
  <td colspan="2" class="field" style="width: 16.5%">'.strtoupper($datosM[43]).' </td>
  </tr>
<tr>
  <td class="label" style="width: 8.25%">OCUPACION</td>
  <td colspan="3" class="field" style="width: 16.5%">'.strtoupper($datosM[44]).'</td>
  <td class="label" style="width: 8.25%">LUGAR DE TRABAJO </td>
  <td colspan="2" class="field" style="width: 16.5%">'.strtoupper($datosM[45]).'</td>
  </tr>
<tr>
  <td colspan="7" class="label" style="width: 8.25%">&nbsp;</td>
</tr>
...
<tr>
  ...
  <td class="field" style="width: 16.5%">'.$datosI[2].' </td>
  </tr>
<tr>
  ...
  <td class="field" style="width: 16.5%">'.strtoupper($datosI[3]).'</td>
  </tr>
<tr>
...
<tr>
  <td colspan="3" class="field" style="width: 8.25%">'.strtoupper($datosI[4]).' </td>
  <td colspan="2" class="field" style="width: 16.5%">'.strtoupper($datosI[5]).'</td>
  <td class="field" style="width: 16.5%">'.strtoupper($datosI[6]).'</td>
</tr>
<tr>
...
<tr>
  <td colspan="3" class="label" style="width: 8.25%">A&Ntilde;OS CUMPLIDOS :______'.$datosI[7].'______</td>
  <td colspan="2" class="label" style="width: 16.5%">_______<b>'.strtoupper($datosI[8]).','.$datosI[9].'</b>__________</td>
...
<tr>
  ...
  <td class="field" style="width: 8.25%">'.strtoupper($datosI[12]).','.$datosI[30].'</td>
...
<tr>
  ...
  <td class="field" style="width: 8.25%">'.$datosI[15].'</td>
  <td class="label" style="width: 8.25%">TELEFONO(S):</td>
  <td class="field" style="width: 16.5%">'.$datosI[16].'&nbsp;&nbsp;Y '.$datosI[17].' </td>
  <td class="label" style="width: 16.5%">CORREO ELECTRONICO </td>
  <td class="field" style="width: 16.5%">'.strtoupper($datosI[18]).'</td>
</tr>
...
<tr>
  <td colspan="6" style="width: 8.25%"><div align="center">
  <strong>TIPO DE DISCAPACIDAD </strong></div></td>
  </tr>
