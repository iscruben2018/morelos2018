	...
	**/
	...
	case 9 :
		...
		if (sizeof ( $datosPublicacion ) > 0) {
			...
			foreach ( $datosPublicacion as $publicaciones ) {
				...
				$cadena .= "<a href='blog/noticias_preview.php?idpublicacion=" . $publicaciones [0] . "'>" . $publicaciones [5] . "</a>";
				$cadena .= "</h2>";
				...
				$cadena .= "</div>";
				$cadena .= "</div>";
				$cadena .= "<br><a href='blog/noticias_preview.php?idpublicacion=" . $publicaciones [0] . "'>Leer M&aacute;s...</a>";
				$cadena .= "</div>";
				/**
				 * ***********FIN CONTENIDO**********************
				 */
	...
	case 18:
		...
		if(sizeof($inscripcion)>0){
			...
			$cadenaReporte.="<td colspan='9' class='subHeader'>&nbsp;</td>";
			$cadenaReporte.="</tr>";
