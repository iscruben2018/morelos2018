...
if(isset($_POST["enviar"])){
	...
	echo "<div align='center'>
		  ...
		  <a style='text-decoration:none;text-transform:uppercase;' href='javascript:window.history.back();'>
...
require_once 'encabezado.php';?>
  ...
  <div align='center'>
  <a href='formatos/tcpdf/vista/reporte_usuarios_pdf.php?cve_ins=<?php echo $folio;?>&ciclo=<?php echo $ciclo;?>&fecha=<?php echo $fecha;?>&matricula=<?php echo $matri_alu;?>&nombre=<?php echo $apellido1."  ".$apellido2."  ".$nombre_alu;?>&semestre=<?php echo $semestre;?>&bachillerato=<?php echo $bachillerato;?>&seccion=<?php echo $seccion;?>'>
  <img src='../images/iconos/print.ico' width="35" height="35">Imprimir Horario</a>
  </div>

<table border='0'><tr>
<td>
<div align="left">
<form  name="form-main" id='form-main' action="asignar_materias.php" method="post" onsubmit="return validarForm(this);">
<table width="250" border="1">
  <tr>
    <td class='tabla' >Folio</td>
    <td style='font-size: 13px;font-weight: bold;'><b><?php echo $folio;?> </b>
    <input type='hidden' name='cve_ins' id='cve_ins' value='<?php echo $folio;?>'>
  ...
  <tr>
    ...
    <input id='bachilleratos' type='hidden' value='<?php echo $cve_bac;?>'>
    </td>
  ...
  <tr >
    ...
    <input id='semestre' type='hidden' value='<?php echo $cve_sem;?>'>
    </td>
  ...
  <input type='button' onclick='buscarMaterias();' value='Buscar Materias'>
  <div id='cargarMaterias'></div>
  <div id='capaMaterias' style='display:none;'>
  <select id='materias' name='materias' onchange='cargarDocentes(this.value);'></select>
  <br><br>
  <label><b>Docente(s)</b></label><br>
  ...
  <b>Hora de inicio:</b>
  <select id='hinicio' name='hinicio'>
 ...
 <option value='7:30'>7:30 am</option>
  ...
  <tr><td><input type='submit' value='Asignar Materias' name='enviar'></td>
  <td><!--  <a href='asignar_materias.php'><input type='button' value='Cancelar'></a>--></td></tr>
</table>
</form>
</div>
</td>
...
<iframe  style='border: none;' src='horario_preview.php?matricula=<?php echo $matricula;?>&cve_ins=<?php echo $folio;?>&no_ciclo=<?php echo $ciclo;?>' width="740px" scrolling='auto;' height="720px"></iframe></div>
</td>
