...
<html dir="ltr" lang="es-MX"><head>
    ...
    <link rel="stylesheet" href="stylenew.css" media="screen">
    <!--[if lte IE 7]>
...
foreach ($publicacion as $noticias){
	...
	$cadena.="<img class='img-rounded' data-u='image' src='images/publicacion/".$noticias[7]."' /></a>";
...
<div class="art-pageslider img-responsive" >
...
<div class="art-sheet clearfix">
    ...
    <div class="art-content-layout-row">
    <div class="art-layout-cell layout-item-0" id='cabecera' style="width:100%;-webkit-border-radius:11px;border: 1px solid #999999;-webkit-border-bottom-left-radius: 0.1em;" >
        <h3 align="center" style="box-sizing: border-box; line-height: 26.399999618530273px;color:#000034;">
        <span style="box-sizing: border-box; font-weight: bold; text-align: center; -webkit-border-horizontal-spacing: 2px; -webkit-border-vertical-spacing: 2px; color: #000034; font-size: 16px;"><span class="glyphicon glyphicon-file" style='color:#000034;'>&nbsp;NOTICIAS&nbsp;</span></span>&nbsp;<a href='blog/noticias.php' style='text-transform:none;text-color:#000034;'> <span class="glyphicon glyphicon-plus" style='color:#000034;'>Leer m&aacute;s</span></a></h3>
...
<article>
								...
								<div class="art-content-layout">
    <div class="art-content-layout-row">
    <div class="art-layout-cell" id='cabecera' style="width:100%;-webkit-border-radius:11px;border: 1px solid #999999;-webkit-border-bottom-left-radius: 0.1em;">
        <p style="text-align: center;"><b><span class="glyphicon glyphicon-bookmark" style="line-height: 107%;color:#000034;text-transform:uppercase;font-size: 20px;">&nbsp;¡Bienvenidos!</span></b><span style="font-size: 22px;">
          </span></p>
    </div>
    </div>
</div><br>
...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell" style="width: 100%" >
         ...
         swf: 'js/videojs/video-js.swf'
           ...
           <video id="example_video_1" class="video-js vjs-default-skin" controls preload="none" width="640" height="360" poster="images/morelospreview1.png" data-setup='{ "html5" : { "nativeTextTracks" : false } }'>
...
<div class="art-content-layout">
     <div class="art-content-layout-row">
     <div class="art-layout-cell" id='cabecera' style="width:100%;-webkit-border-radius:11px;border: 1px solid #999999;-webkit-border-bottom-left-radius: 0.1em;">
          <p style="text-align: center;"><b><span class="glyphicon glyphicon-exclamation-sign" style="line-height: 107%;color:#000034;text-transform:uppercase;font-size: 20px;">&nbsp;Informaci&oacute;n</span></b><span style="font-size: 22px;">
          </span></p>
      </div>
     </div>
</div
<br>
        ...
        <p style="box-sizing: border-box; color: rgb(51, 51, 51); line-height: 18.571428298950195px; "><br style="box-sizing: border-box;"></p>
...
<article >-->
<!--<div class="art-content-layout">-->
    <!--<h3 id='cabecera' style="width:100%;-webkit-border-radius:11px;border: 1px solid #999999;-webkit-border-bottom-left-radius: 0.1em;"></h3>-->
   <!-- <div class="art-content-layout-row" >

    <div class="art-layout-cell" style="width: 100%" >
        <img width="572" height="250" style="float: left;" alt="" src="images/logomorelos.png" class="" >
...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell" style="width: 100%" >
     ...
     <img width="420" height="240" alt="" src="images/logo1-large.png" class="">
...
-moz-border-radius: 6px;border-radius: 6px;-webkit-box-shadow: 0 0 3px 2px rgba(0, 0, 0, 0.2);-moz-box-shadow: 0 0 3px 2px rgba(0, 0, 0, 0.2);box-shadow: 0 0 3px 2px rgba(0, 0, 0, 0.2);border: 1px solid #B2C1D1;margin: 7px;"> 
   ...
   <span style="line-height: 107%; font-family: 'Lucida Calligraphy'; color: rgb(91, 155, 213); font-size: 30px;">Agenda</span>
     ...
     <div class="art-block clearfix">
        ...
        <div class="art-blockcontent">
        <div>
        <div class="art-blockheader"><h3 class="t"><span class="glyphicon glyphicon-calendar"></span>&nbsp;EVENTOS</h3></div>
        <div class="art-vmenublockcontent">
             <ul class="art-vmenu">
     ...
     <div class="art-block clearfix">
        ...
        <div class="art-blockcontent">
        <p>Siguenos en fb</p><p><br></p><p>&nbsp;<a href="" class="art-facebook-tag-icon" style="line-height: 33px;"></a>
        &nbsp;&nbsp;<a href="" class="art-youtube-tag-icon" style="line-height: 32px; "></a>&nbsp;<br></p>
        <p>Escuela Preparatoria Morelos de Zit&aacute;cuaro,S.C</p></div>
     </div>
     <!--FB-->
</div>
...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell layout-item-old-0" style="width: 33%">
        ...
        <p style="text-align: justify;"><span style="font-size: 12px;">
         Cont&aacute;ctanos:&nbsp;<a href="https://wwww.facebook.com/Esc-Prepa-Jose-Ma-Morelos-De-Zitacuaro-514038705306620/info/?tab=overview" class="art-facebook-tag-icon"></a>
    ...
    <div class="modal-content"> 
         ...
         <div class="modal-body" style='background:url(images/block.png)'> 
           ...
           <b style='color:black;'> 
            ...
            (ESCUELA PREPARATORIA JOS&Eacute; MA. MORELOS DE ZIT&Aacute;CUARO,S.C;U.M.S.N.H,ICATMI)
           ...
           <b style='color:black;'> 
            ...
            <li>
                <b style='color:black;'>
                 ...
                 personas ajenas a la institución o acceso desde otros redes no seguras.
                 ...
                 y evitar compartir dispositivos tales como teléfonos celulares,computadoras port&aacute;tiles si as&iacute; fuera el caso para evitar este tipo de 
                 incidentes.
                </b>
            </li>
            <li>
                <b style='color:black;'>
                Los t&eacute;rminos del presente documento estan sujetos a cambios en cualquier momento,as&iacute; como el cese de servicios y acceso a los mismos por parte del usuario.
                </b>
            </li>
               <li>
           <b style='color:black;'> 
            La disponibilidad de datos para consulta,uso de servicios y acceso a la p&aacute;gina estar&aacute; disponible en las secciones 
            correspondientes de acuerdo al periodo requerido(o periodo extra si fuera el caso),teniendo en cuenta el dispositivo
            usado por el usuario para el acceso a la p&aacute;gina y el rendimiento del equipo de c&oacute;mputo,considerando un comportamiento 
            distinto en distintos casos,excluyendo de ello a la p&aacute;gina y/o desarrollador. 
            P&aacute;gina adaptada para dispositivos m&oacute;viles,pudiendo no visualizarse en algunos dispositivos y navegadores antiguos.
            El contenido que aparece en la p&aacute;gina y hace referencia a la instituci&oacute;n y/o terceros pertenece a las mismas,no perteneciendo
            a persona en particular(participantes directos o indirectos en la elaboraci&oacute;n de la p&aacute;gina,excluyendo de dicha responsabilidad a estos).
            Para m&aacute;s informaci&oacute;n y/o dudas,dirigirse a las instancias correspondientes o  realizar contacto por medio electr&oacute;nico a las direcciones mencionadas en pie de p&aacute;gina. 
        </b>
            </li>
         ...
         <div class="modal-footer" style='background:url(images/block.png)'> 
            <h4 style='color:#000034;'>Actualizaci&oacute;n 10 de Julio del 2016</h4>
            <br>
...
<!--FIN PIE DE PAGINA-->
<a href="#" class="scrollup" style="display: inline;">RES<img src='images/icono.jpg'></a>
