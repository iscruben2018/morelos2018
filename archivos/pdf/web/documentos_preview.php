...
var DEFAULT_URL = "<?php echo $_GET['documento']?>";
    ...
    <div id="outerContainer">
        ...
        <div id="toolbarSidebar">
          <div class="splitToolbarButton toggled">
            ...
            <button id="viewOutline" class="toolbarButton group" title="Show Document Outline" tabindex="3" data-l10n-id="outline">
               <span data-l10n-id="outline_label">Documento Outline</span>
            </button>
      ...
      <div id="mainContainer">
        <div class="findbar hidden doorHanger hiddenSmallView" id="findbar">
          ...
          <label for="findMatchCase" class="toolbarLabel" data-l10n-id="find_match_case_label">Encontrar coincidencia</label>
        ...
        <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
          <div id="secondaryToolbarButtonContainer">
            <button id="secondaryPresentationMode" class="secondaryToolbarButton presentationMode visibleLargeView" title="Cambiar modo presentacion" tabindex="51" data-l10n-id="presentation_mode">
            ...
            <a href="#" id="secondaryViewBookmark" class="secondaryToolbarButton bookmark visibleSmallView" title="Vista Actual tabindex="55" data-l10n-id="bookmark">
            ...
            <button id="lastPage" class="secondaryToolbarButton lastPage" title="Ir a la ultima página" tabindex="57" data-l10n-id="last_page">
              <span data-l10n-id="last_page_label">Ir a la ultima p&aacute;gina</span>
            </button>

            <div class="horizontalToolbarSeparator"></div>

            <button id="pageRotateCw" class="secondaryToolbarButton rotateCw" title="Rotar en sentido de las agujas del reloj" tabindex="58" data-l10n-id="page_rotate_cw">
              <span data-l10n-id="page_rotate_cw_label">Rotar en sentido de las agujas del reloj</span>
            </button>
            <button id="pageRotateCcw" class="secondaryToolbarButton rotateCcw" title="Rotar en sentido opuesto a las agujas del reloj" tabindex="59" data-l10n-id="page_rotate_ccw">
              <span data-l10n-id="page_rotate_ccw_label">Rotar en sentido opuesto a las agujas del reloj</span>
            </button>

            <div class="horizontalToolbarSeparator"></div>

            <button id="toggleHandTool" class="secondaryToolbarButton handTool" title="Enable hand tool" tabindex="60" data-l10n-id="hand_tool_enable">
              <span data-l10n-id="hand_tool_enable_label">Habilitar herramienta hand</span>
            </button>

            <div class="horizontalToolbarSeparator"></div>

            <button id="documentProperties" class="secondaryToolbarButton documentProperties" title="Propiedades del documento
            " tabindex="61" data-l10n-id="document_properties">
            ...
            <div id="toolbarViewer">
              <div id="toolbarViewerLeft">
                <button id="sidebarToggle" class="toolbarButton" title="Toggle Sidebar" tabindex="11" data-l10n-id="toggle_sidebar">
                  <span data-l10n-id="toggle_sidebar_label">Desplegar barra lateral</span>
                </button>
                <div class="toolbarButtonSpacer"></div>
                <button id="viewFind" class="toolbarButton group hiddenSmallView" title="Encontrar en el documento" tabindex="12" data-l10n-id="findbar">
                   <span data-l10n-id="findbar_label">Encontrar</span>
                </button>
                <div class="splitToolbarButton">
                  <button class="toolbarButton pageUp" title="Anterior" id="previous" tabindex="13" data-l10n-id="previous">
                    <span data-l10n-id="previous_label">Anterior</span>
                  </button>
                  <div class="splitToolbarButtonSeparator"></div>
                  <button class="toolbarButton pageDown" title="Siguiente" id="next" tabindex="14" data-l10n-id="next">
              ...
              <div id="toolbarViewerRight">
                <button id="presentationMode" class="toolbarButton presentationMode hiddenLargeView" title="Cambiar a modo presentacion" tabindex="31" data-l10n-id="presentation_mode">
                  <span data-l10n-id="presentation_mode_label">Cambiar a modo presentacion</span>
                </button>
                ...
                <a href="#" id="viewBookmark" class="toolbarButton bookmark hiddenSmallView" title="Vista actual" tabindex="35" data-l10n-id="bookmark">
                  <span data-l10n-id="bookmark_label">Vista Actual</span>
                </a>
                ...
                <div class="innerCenter" id="toolbarViewerMiddle">
                  ...
                  <span id="scaleSelectContainer" class="dropdownToolbarButton">
                     <select id="scaleSelect" title="Zoom" tabindex="23" data-l10n-id="zoom">
                      ...
                      <option id="pageFitOption" title="" value="page-fit" data-l10n-id="page_scale_fit">Acomodar pagina</option>
      ...
      <div id="overlayContainer" class="hidden">
        <div id="passwordOverlay" class="container hidden">
          <div class="dialog">
            <div class="row">
              <p id="passwordText" data-l10n-id="password_label">Ingresa el password para abrir este PDF</p>
            </div>
            <div class="row">
        ...
        <div id="documentPropertiesOverlay" class="container hidden">
          <div class="dialog">
            ...
            <div class="row">
              <span data-l10n-id="document_properties_file_size">Tama&ntilde;o:</span> <p id="fileSizeField">-</p>
            </div>
            ...
            <div class="row">
              <span data-l10n-id="document_properties_page_count">No de paginas:</span> <p id="pageCountField">-</p>
            </div>
            <div class="buttonRow">
